...
class Scenario_manager(Node):
    ...
    def __init__(self):
        ...
        if self.path_type == 'complex':
            ...
            path1_poses = [[2.5, 0.0, 0.0], [3.8, 0.0, 0.0], [4.2, 0.0, 0.0], [4.9, 1.0, 1.6],  [4.9, 2.0, 1.6], [4.9, 2.3, 1.6],
                 [5.7, 2.6, 0.0], [6.3, 2.6, 0.0], [7.0, 2.6, 0.0],[8.0, 2.6, 0.0], [8.7, 2.6, 0.0], [9.5, 2.6, 0.0], [10.5, 3.9, 1.5], [10.5, 7.5, 1.5]]
            path2_poses = [[2.5, 0.0, 0.0], [3.8, 0.0, 0.0], [4.2, 0.0, 0.0], [4.9, -0.9, -1.6], [5.0, -2.3, -1.6], [5.7, -2.3, -1.6], [6.0, -2.6, 0.0],
                 [8.3, -2.6, 0.0], [9.3, -2.6, 0.0], [10.0, -2.6, 0.0], [10.5, -1.7, 1.6], [10.5, -0.6, 1.6], [10.5, 2.9, 1.6], [10.5, 6.5, 1.6], [10.5, 7.5, 1.6]]
