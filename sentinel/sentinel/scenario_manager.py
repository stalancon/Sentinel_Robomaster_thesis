    ...
    def __init__(self):
        ...
        if self.path_type == 'complex':
            ...
            if sim:
                ...
                path1_poses = [[-1.0, 0.0, 0.0], [-0.5, 0.0, 0.0], [-0.2, 0.0, -1.6], [-0.2, -0.5, -1.6], [-0.2, -0.5, -1.6],[-0.5, -0.8, -1.6],[-0.5, -1.0, -1.6],[0.0, -1.5, 0.0],[1.0, -1.5, 0.0],[1.5, -1.0, 1.6],
                 [1.5, 1.5, 1.6],[1.5, 2.0, 1.6]]
                path2_poses = [[-1.0, 0.0, 0.0], [-0.5, 0.0, 0.0], [-0.2, 0.0, 1.6], [-0.2, 0.8, 1.6], [-0.2, 1.2, 1.6],[-0.2, 1.2, 1.6],[-0.2, 1.5, 1.6],[0.0, 1.5, 0.0], [0.5, 1.5, 0.0],
            ...
            if sim:
                poses_path = [[1.0, -1.5, 0.0], [1.3, -1.5, 0.0], [1.8, -0.8, 1.5], [1.8, -0.4, 1.5], [1.8, 1.0, 1.5], [1.8, 1.8, 1.5]] 
            else:
